...
class TestAutoEncoder(unittest.TestCase):
    def __init__(self, *args, **kwargs):
        ...
        self.model = AutoEncoder(config=AutoEncoder.config_class(num_epochs=10))
    ...
    def test_save_load(self):
        ...
        self.model.save(dirname=join(rootdir, "tmp", "ae"))
        loaded_model = AutoEncoder.load(dirname=join(rootdir, "tmp", "ae"))
